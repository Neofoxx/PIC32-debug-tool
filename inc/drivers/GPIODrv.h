...
// LED USB_INTERRUPT - CON 1-10
#define LEDUSBINT_TRISbits		TRISEbits
#define LEDUSBINT_TRISPIN		TRISE7
#define LEDUSBINT_LATbits		LATEbits
#define LEDUSBINT_LATPIN		LATE7
#define LEDUSBINT_LATINV		LATEINV
#define LEDUSBINT_MASK			(1<<7)

// LED USB_EP_UART_OUT (PC to us) - CON 1-11
#define LEDUSBUART_OUT_TRISbits		TRISFbits
#define LEDUSBUART_OUT_TRISPIN		TRISF1
#define LEDUSBUART_OUT_LATbits		LATFbits
#define LEDUSBUART_OUT_LATPIN		LATF1
#define LEDUSBUART_OUT_LATINV		LATFINV
#define LEDUSBUART_OUT_MASK			(1<<1)
...
// LED USB_EP_PROG_OUT (PC to us) - CON 1-14
#define LEDUSBPROG_OUT_TRISbits		TRISDbits
#define LEDUSBPROG_OUT_TRISPIN		TRISD8
#define LEDUSBPROG_OUT_LATbits		LATDbits
#define LEDUSBPROG_OUT_LATPIN		LATD8
#define LEDUSBPROG_OUT_LATINV		LATDINV
#define LEDUSBPROG_OUT_MASK			(1<<8)

// LED USB_EP_PROG_IN (us to PC) - CON 1-15
#define LEDUSBPROG_IN_TRISbits		TRISDbits
#define LEDUSBPROG_IN_TRISPIN		TRISD7
#define LEDUSBPROG_IN_LATbits		LATDbits
#define LEDUSBPROG_IN_LATPIN		LATD7
#define LEDUSBPROG_IN_LATINV		LATDINV
